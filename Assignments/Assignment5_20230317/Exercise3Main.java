...
public class Exercise3Main {
	...
	System.out.println("Employee address: "+ A1.getBuildingNo()+" , "+ A1.getStreet()+" , "+ A1.getDistrict()+" , "+ A1.getState());
	...
	System.out.println("Employee address: "+ A2.getBuildingNo()+" , "+ A2.getStreet()+" , "+ A2.getDistrict()+" , "+ A2.getState());
